...
| Passive prompt-cache controls   | Configure legacy/off/smart cache behavior by project, session, provider, and exact model without enabling keepalive or remote-cache deletion.                                                        | [CLI, setup, and configuration](cli-setup-configuration.md#prompt-cache-controls)         |
