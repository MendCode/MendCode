...
- `MendCode` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `MendCode` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `MendCode` inside commands, URLs, package names, or code literals
