...
import { createOpencodeClient } from "@mendcode/sdk"
...
function useShareUrl() {
  return isMock() ? "https://dev.mendcode.ai" : "https://mendcode.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.mendcode.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.mendcode.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
