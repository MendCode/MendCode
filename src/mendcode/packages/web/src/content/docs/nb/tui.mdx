---
title: TUI
description: Bruke MendCode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MendCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre MendCode starter TUI for gjeldende katalog.
...
Når du bruker MendCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til MendCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt MendCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `mendcode.json`, som konfigurerer server-/kjøretidsoppførsel.
