...
Opprett `.mendcode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom MendCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i MendCode [config](/docs/config):
...
- Per prosjekt: `.mendcode/commands/`
...
MendCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
