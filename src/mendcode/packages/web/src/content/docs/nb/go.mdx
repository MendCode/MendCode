...
MendCode Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
MendCode Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i MendCode. Du abonnerer på MendCode Go og
...
MendCode Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

MendCode Go fungerer som enhver annen leverandør i MendCode.

1. Du logger inn på **<a href={console}>MendCode Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `MendCode Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på MendCode Go.
:::
...
MendCode Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din MendCode-konfigurasjon
bruker formatet `MendCode-go/<model-id>`. For eksempel, for Kimi K2.6, vil du
bruke `MendCode-go/kimi-k2.6` i konfigurasjonen din.
...
Vi opprettet MendCode Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med MendCode også.
