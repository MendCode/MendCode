---
title: LSP-servere
description: MendCode integreres med LSP-serverne dine.
---

MendCode integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

MendCode kommer med flere innebygde LSP-servere for populære språk:
...
Når MendCode åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i MendCode-konfigurasjonen.
