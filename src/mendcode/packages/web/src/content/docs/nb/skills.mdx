...
Agentferdigheter lar MendCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går MendCode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
MendCode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `mendcode.json`:
