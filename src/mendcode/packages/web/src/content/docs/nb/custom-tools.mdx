...
description: Lag verktøy som LLM kan kalle inn MendCode.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med MendCode sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.mendcode/tools/`-katalogen til prosjektet ditt.
