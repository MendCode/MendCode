...
description: MendCode, LSP sunucularınızla bütünleşir.
---

MendCode, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

MendCode, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
MendCode bir dosyayı açtığında:
...
LSP sunucularını, MendCode yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
