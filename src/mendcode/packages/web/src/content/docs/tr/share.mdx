---
title: Paylasim
description: MendCode konusmalarini genel baglantilarla paylasin.
---

MendCode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda MendCode:
...
MendCode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak MendCode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `mendcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda MendCode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
