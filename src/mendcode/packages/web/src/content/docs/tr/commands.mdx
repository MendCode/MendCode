...
`.mendcode/commands/test.md` oluştur:
...
MendCode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

MendCode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Proje başına: `.mendcode/commands/`
...
MendCode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
