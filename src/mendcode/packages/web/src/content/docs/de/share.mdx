---
title: Teilen
description: Teile MendCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu MendCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht MendCode Folgendes:
...
MendCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt MendCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`mendcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du MendCode in deiner Organisation einsetzt.
