---
title: TUI
description: Arbeite mit MendCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MendCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet MendCode die TUI im aktuellen Verzeichnis.
...
In der MendCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu MendCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet MendCode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `mendcode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
