...
description: Erstellen Sie Tools, die der LLM in MendCode aufrufen kann.
---

Benutzerdefinierte Tools sind von Ihnen erstellte Funktionen, die der LLM während Gesprächen aufrufen kann. Sie arbeiten neben [built-in tools](/docs/tools) von MendCode wie `read`, `write` und `bash`.
...
- Lokal, indem Sie sie im Verzeichnis `.mendcode/tools/` Ihres Projekts platzieren.
