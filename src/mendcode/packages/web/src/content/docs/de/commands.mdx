...
Erstellen Sie `.mendcode/commands/test.md`:

```md title=".mendcode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die MendCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem MendCode [config](/docs/config):

```json title="mendcode.jsonc" {4-12}
{
...
```md title=".mendcode/commands/component.md"
---
...
```md title=".mendcode/commands/create-file.md"
---
...
```md title=".mendcode/commands/analyze-coverage.md"
---
...
```md title=".mendcode/commands/review-changes.md"
---
...
```md title=".mendcode/commands/review-component.md"
---
...
MendCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
