---
title: LSP Server
description: MendCode lässt sich in Ihren LSP-Server integrieren.
---

MendCode lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

MendCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn MendCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer MendCode-Konfiguration anpassen.
