---
title: TUI
description: Brug af MendCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MendCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre MendCode starter TUI for den nuværende mappe.
...
Når du bruger MendCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til MendCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut MendCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `mendcode.json`, som konfigurerer server-/kørselstidsadfærd.
