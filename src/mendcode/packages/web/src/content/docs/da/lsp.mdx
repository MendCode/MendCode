---
title: LSP-servere
description: MendCode integreres med dine LSP-servere.
---

MendCode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

MendCode leveres med flere indbyggede LSP-servere til populære sprog:
...
Når MendCode åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din MendCode-konfiguration.
