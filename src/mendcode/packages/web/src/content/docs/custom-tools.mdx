---
title: Custom Tools
description: Create tools the LLM can call in MendCode.
---

Custom tools are functions you create that the LLM can call during conversations. They work alongside MendCode's [built-in tools](/docs/tools) like `read`, `write`, and `bash`.
...
- Locally by placing them in the `.mendcode/tools/` directory of your project.
