---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala MendCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MendCode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie MendCode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI MendCode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do MendCode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij MendCode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `mendcode.json`, który konfiguruje zachowanie serwera/runtime.
