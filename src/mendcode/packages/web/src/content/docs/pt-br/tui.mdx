---
title: TUI
description: Usando a interface de usuário de terminal MendCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O MendCode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar MendCode inicia o TUI para o diretório atual.
...
Ao usar o TUI do MendCode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao MendCode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do MendCode. _Aliases_: `/quit`, `/q`
...
Isso é separado do `mendcode.json`, que configura o comportamento do servidor/runtime.
