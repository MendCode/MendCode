...
description: O MendCode integra-se aos seus servidores LSP.
---

O MendCode integra-se ao seu Protocolo de Servidor de Linguagem (LSP) para ajudar o LLM a interagir com sua base de código. Ele usa diagnósticos para fornecer feedback ao LLM.

---

## Integrados

O MendCode vem com vários servidores LSP integrados para linguagens populares:
...
Quando o MendCode abre um arquivo, ele:
...
Você pode personalizar os servidores LSP através da seção `lsp` na sua configuração do MendCode.
