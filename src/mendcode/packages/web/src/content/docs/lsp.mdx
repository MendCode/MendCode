---
title: LSP Servers
description: MendCode integrates with your LSP servers.
---

MendCode can integrate with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

MendCode comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and MendCode opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your MendCode config.
