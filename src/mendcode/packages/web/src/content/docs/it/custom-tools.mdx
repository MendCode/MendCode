...
description: Crea strumenti che l'LLM puo chiamare in MendCode.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di MendCode come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.mendcode/tools/` del progetto.
