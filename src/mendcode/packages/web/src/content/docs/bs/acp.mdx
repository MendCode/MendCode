---
title: ACP podrška
description: Koristite MendCode u bilo kojem uređivaču kompatibilnom sa ACP.
---

MendCode podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili MendCode putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `mend acp`.

Naredba pokreće MendCode kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "MendCode" agenta u AI Chat agent selektoru.
...
Da koristite MendCode kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi MendCode kao ACP chat agenta.
...
MendCode radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj MendCode konfiguraciji
