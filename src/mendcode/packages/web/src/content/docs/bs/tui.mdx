---
title: TUI
description: Korištenje korisničkog interfejsa MendCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MendCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje MendCode pokreće TUI za trenutni direktorij.
...
Kada koristite MendCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u MendCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz MendCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `mendcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
