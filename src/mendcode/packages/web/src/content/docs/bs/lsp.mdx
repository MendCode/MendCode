---
title: LSP serveri
description: MendCode se integriše sa vašim LSP serverima.
---

MendCode se integriše sa vašim Language Server Protocol (LSP) serverima kako bi pomogao LLM-u u interakciji s kodnom bazom. Koristi dijagnostiku za slanje povratnih informacija modelu.

## Ugrađeni

MendCode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Možete prilagoditi LSP servere kroz `lsp` odjeljak u vašoj MendCode konfiguraciji.
