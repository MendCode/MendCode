...
Kreiraj `.mendcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz MendCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom MendCode [config](/docs/config):
...
MendCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
