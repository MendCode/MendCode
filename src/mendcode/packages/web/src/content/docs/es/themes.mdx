...
Con MendCode puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, MendCode usa nuestro propio tema `MendCode`.
...
MendCode viene con varios temas integrados.
...
- Quiere que MendCode coincida con la apariencia de su terminal
...
MendCode admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
3. **Directorio raíz del proyecto**: definido en `<project-root>/.mendcode/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.mendcode/themes/*.json`
