---
title: TUI
description: Usando la interfaz de usuario del terminal MendCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MendCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar MendCode se inicia TUI para el directorio actual.
...
Cuando utilice MendCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a MendCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de MendCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `mendcode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
