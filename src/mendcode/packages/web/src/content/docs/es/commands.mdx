...
Crear `.mendcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración MendCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su MendCode [config](/docs/config):
...
- Por proyecto: `.mendcode/commands/`
...
MendCode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
