...
description: MendCode se integra con sus servidores LSP.
---

MendCode se integra con su protocolo de servidor de idiomas (LSP) para ayudar a LLM a interactuar con su código base. Utiliza diagnósticos para proporcionar retroalimentación al LLM.

---

## Incorporados

MendCode viene con varios servidores LSP integrados para idiomas populares:
...
Cuando MendCode abre un archivo:
...
Puede personalizar los servidores LSP a través de la sección `lsp` en su configuración MendCode.
