...
مع MendCode يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم MendCode سمتنا `MendCode`.
...
يأتي MendCode مع عدة سمات مدمجة.
...
- يريدون أن يطابق MendCode مظهر terminal لديهم
...
يدعم MendCode نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.mendcode/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.mendcode/themes/*.json`
