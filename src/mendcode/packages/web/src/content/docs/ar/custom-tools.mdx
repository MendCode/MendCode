...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في MendCode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في MendCode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.mendcode/tools/` داخل مشروعك.
