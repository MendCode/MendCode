...
يوجد نوعان من الوكلاء في MendCode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي MendCode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي MendCode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي MendCode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `mendcode.json`:
...
إذا لم يتم تحديد temperature، يستخدم MendCode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات MendCode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات MendCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [MendCode Zen](/docs/zen)، فستستخدم `MendCode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `mend models` لعرض قائمة بالنماذج المتاحة.
:::
