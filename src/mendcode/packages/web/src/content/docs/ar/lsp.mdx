---
title: خوادم LSP
description: يتكامل MendCode مع خوادم LSP لديك.
---

يتكامل MendCode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي MendCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات MendCode.
