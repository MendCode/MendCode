---
title: دعم ACP
description: استخدم MendCode في أي محرر متوافق مع ACP.
---

يدعم MendCode بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام MendCode عبر ACP، اضبط محررك ليشغّل الأمر `mend acp`.

يشغّل هذا الأمر MendCode كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'MendCode' من محدد الوكلاء في AI Chat.
...
لاستخدام MendCode كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام MendCode كوكيل ACP للدردشة.
...
يعمل MendCode عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات MendCode
