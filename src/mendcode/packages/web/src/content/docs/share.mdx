---
title: Share
description: Share your MendCode conversations.
---

MendCode's share feature allows you to create public links to your MendCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, MendCode:
...
MendCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, MendCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `mendcode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using MendCode in your organization.
