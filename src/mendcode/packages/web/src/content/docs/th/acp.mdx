---
title: การรองรับ ACP
description: ใช้ MendCode ในโปรแกรมแก้ไขที่รองรับ ACP
---

MendCode รองรับ [Agent Client Protocol](https://agentclientprotocol.com) (ACP) ซึ่งช่วยให้สามารถทำงานร่วมกับ editor และ IDE ต่างๆ ได้โดยตรง
...
ในการใช้ MendCode ผ่าน ACP ให้กำหนดค่าโปรแกรมแก้ไขของคุณให้รันคำสั่ง `mend acp`

คำสั่งนี้จะเริ่ม MendCode เป็น process ย่อยที่รองรับ ACP ซึ่งสื่อสารกับโปรแกรมแก้ไขของคุณผ่าน JSON-RPC ทาง stdio
...
นี่เป็นการเปิดให้ตัวแทน 'MendCode' ในเนื้อหาของตัวแทน AI Chat
...
ลองใช้ MendCode ACP ใน [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ให้เพิ่มสิ่งต่อไปนี้ใน Neovim ของคุณ:
...
คุณสามารถใช้ CodeCompanion เพื่อใช้ MendCode เป็น ACP agent สำหรับแชท
...
MendCode ทำงานผ่าน ACP เหมือนกับใน terminal และรองรับฟีเจอร์ทั้งหมด:
...
- MCP แขกที่นี่คือข้อมูลเพิ่มเติมของ MendCode ของคุณ
