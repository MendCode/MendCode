...
import type { MessageV2 } from "mendcode/session/message-v2"
import type { Message } from "mendcode/session/message"
import type { Session } from "mendcode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.mendcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.mendcode_name}>
