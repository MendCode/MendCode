import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@mendcode/sdk/v2"
import { SessionTurn } from "@mendcode/ui/session-turn"
import { SessionReview } from "@mendcode/ui/session-review"
import { DataProvider } from "@mendcode/ui/context"
import { FileComponentProvider } from "@mendcode/ui/context/file"
import { WorkerPoolProvider } from "@mendcode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@mendcode/ui/logo"
import { IconButton } from "@mendcode/ui/icon-button"
import { ProviderIcon } from "@mendcode/ui/provider-icon"
import { iife } from "@mendcode/core/util/iife"
...
import { Tabs } from "@mendcode/ui/tabs"
import { MessageNav } from "@mendcode/ui/message-nav"
import { FileSSR } from "@mendcode/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@mendcode/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/mendcode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | MendCode</Title>
              </Show>
              <Meta name="description" content="MendCode - The AI coding agent built for the terminal." />
