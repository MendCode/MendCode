...
beforeAll(async () => {
  ...
  mock.module("@mendcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@mendcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@mendcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@mendcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
