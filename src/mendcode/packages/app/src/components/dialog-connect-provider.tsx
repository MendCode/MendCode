import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@mendcode/sdk/v2/client"
import { Button } from "@mendcode/ui/button"
import { useDialog } from "@mendcode/ui/context/dialog"
import { Dialog } from "@mendcode/ui/dialog"
import { Icon } from "@mendcode/ui/icon"
import { IconButton } from "@mendcode/ui/icon-button"
import { List, type ListRef } from "@mendcode/ui/list"
import { ProviderIcon } from "@mendcode/ui/provider-icon"
import { Spinner } from "@mendcode/ui/spinner"
import { TextField } from "@mendcode/ui/text-field"
import { showToast } from "@mendcode/ui/toast"
        ...
        <Switch>
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.mendcodeZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.mendcodeZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.mendcodeZen.visit.prefix")}
                <Link href="https://mendcode.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.mendcodeZen.visit.link")}
                </Link>
                {language.t("provider.connect.mendcodeZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
