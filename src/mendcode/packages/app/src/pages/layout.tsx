...
import { base64Encode } from "@mendcode/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@mendcode/ui/resize-handle"
import { Button } from "@mendcode/ui/button"
import { IconButton } from "@mendcode/ui/icon-button"
import { Tooltip } from "@mendcode/ui/tooltip"
...
import { Session, type Message } from "@mendcode/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@mendcode/ui/toast"
...
import { retry } from "@mendcode/core/util/retry"
...
import { useTheme, type ColorScheme } from "@mendcode/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://mendcode.ai/desktop-feedback")}
      renderPanel={() =>
