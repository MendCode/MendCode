export const dict = {
  ...
  "dialog.provider.mendcode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.mendcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.mendcodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por MendCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MendCode.",
  ...
  "provider.connect.mendcodeZen.line1":
    "MendCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.mendcodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.mendcodeZen.visit.prefix": "Visita ",
  "provider.connect.mendcodeZen.visit.link": "mendcode.ai/zen",
  "provider.connect.mendcodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MendCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MendCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en mendcode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de MendCode se conecta esta app.",
  ...
  "context.usage.scope": "Alcance",
  "context.usage.latestTurn": "Ultimo turno",
  "context.usage.clickToView": "Haz clic para ver contexto",
  "context.usage.view": "Ver uso del contexto",
  "context.usage.viewLatestTurn": "Ver uso del contexto del ultimo turno",
  ...
  "toast.update.description": "Una nueva versión de MendCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de MendCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (mendcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, MendCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "MendCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "app.name.desktop": "MendCode Desktop",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MendCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MendCode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve MendCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MendCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MendCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MendCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MendCode.",
  ...
  "settings.models.title": "Selector de modelos",
  "settings.models.description": "Elige qué modelos conectados aparecen en el selector.",
