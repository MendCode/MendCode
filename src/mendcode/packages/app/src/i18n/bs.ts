export const dict = {
  ...
  "dialog.provider.mendcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.mendcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.mendcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MendCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MendCode-u.",
  ...
  "provider.connect.mendcodeZen.line1":
    "MendCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.mendcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.mendcodeZen.visit.link": "mendcode.ai/zen",
  "provider.connect.mendcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MendCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MendCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u mendcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se MendCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija MendCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MendCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (mendcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MendCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MendCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MendCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MendCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako MendCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MendCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MendCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MendCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MendCode-a.",
