export const dict = {
  ...
  "dialog.provider.mendcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.mendcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.mendcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MendCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MendCode.",
  ...
  "provider.connect.mendcodeZen.line1":
    "MendCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.mendcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.mendcodeZen.visit.link": "mendcode.ai/zen",
  "provider.connect.mendcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MendCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MendCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w mendcode.json",
  ...
  "dialog.server.description": "Przełącz serwer MendCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja MendCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MendCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (mendcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "MendCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MendCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd MendCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MendCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MendCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MendCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MendCode.",
