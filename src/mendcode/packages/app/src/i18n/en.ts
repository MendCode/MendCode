export const dict = {
  ...
  "dialog.provider.mendcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.mendcode.tagline": "Reliable optimized models",
  "dialog.provider.mendcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MendCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MendCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.mendcodeZen.line1":
    "MendCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.mendcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.mendcodeZen.visit.prefix": "Visit ",
  "provider.connect.mendcodeZen.visit.link": "mendcode.ai/zen",
  "provider.connect.mendcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MendCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MendCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in mendcode.json",
  ...
  "dialog.server.description": "Switch which MendCode server this app connects to.",
  ...
  "context.usage.scope": "Scope",
  "context.usage.latestTurn": "Latest turn",
  "context.usage.clickToView": "Click to view context",
  "context.usage.view": "View context usage",
  "context.usage.viewLatestTurn": "View latest turn context usage",
  ...
  "toast.update.description": "A new version of MendCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MendCode team",
  ...
  "error.chain.checkConfig": "Check your config (mendcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MendCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MendCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the MendCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MendCode",
  ...
  "settings.general.row.appearance.description": "Customise how MendCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MendCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MendCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MendCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MendCode.",
  ...
  "settings.models.description": "Choose which connected models appear in the selector.",
