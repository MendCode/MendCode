...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>MendCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="MendCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to MendCode. Please read on to learn the rules and restrictions that govern your use of
                MendCode&apos;s website, inference product and hosted software offering (the "Services"). If you have
                any questions, comments, or concerns regarding these terms or the Services, please contact us at:
              </p>

              <p>
                Email: <a href="mailto:contact@mendcode.ai">contact@mendcode.ai</a>
              </p>

              <p>
                These Terms of Use (the "Terms") are a binding contract between you and{" "}
                <strong>MENDCODE, INC.</strong> ("MendCode," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>MendCode Privacy Policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-mendcode">What is MendCode?</h2>
              <p>
                MendCode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the MendCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, MendCode enables you to
              ...
              <p>
                ...
                our website, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                MendCode takes the privacy of its users very seriously. For the current MendCode Privacy Policy, please
                click here <a href={language.route("/legal/privacy-policy")}>MendCode Privacy Policy</a>.
              </p>
              ...
              <p>
                ...
                us personal information, please contact us at <a href="mailto:contact@mendcode.ai">contact@mendcode.ai</a>.
              </p>

              <h2 id="what-are-the-basics">What are the basics of using MendCode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by MendCode;
                </li>
                <li>
              ...
              <p>
                If you use MendCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                MendCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                MendCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-mendcode-ever-change-the-services">Will MendCode ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                Services"). Please see our Paid Services page <a href={language.route("/zen")}>MendCode Zen</a> for a
                description of the current Paid
              ...
              <p>
                ...
                OR CHANGE YOUR PAYMENT METHOD, GO TO ACCOUNT SETTINGS <a href="/auth">/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href="mailto:contact@mendcode.ai">contact@mendcode.ai</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>MendCode Privacy Policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                MendCode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. MendCode has the sole right to decide whether you are
              ...
              <p>
                MendCode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (MendCode and all such
                parties together, the "MendCode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the MendCode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The MendCode Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY MENDCODE (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                MENDCODE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO MENDCODE IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the MendCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without MendCode's prior written
              ...
              <p>
                ...
                disputes and claims with MendCode and limits the manner in which you can seek relief from MendCode. Both
                you and MendCode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, MendCode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. MendCode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. MendCode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or MendCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND MENDCODE WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and MendCode are instead choosing to have claims and disputes resolved by
                ...
                you and MendCode over whether to vacate or enforce an arbitration award, YOU AND MENDCODE WAIVE ALL
              ...
              <p>
                ...
                MendCode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or MendCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and MendCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the MendCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and MendCode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and MendCode, and
                ...
                are not an employee, agent, partner, or joint venture of MendCode, and you do not have any authority of
                any kind to bind MendCode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and MendCode
