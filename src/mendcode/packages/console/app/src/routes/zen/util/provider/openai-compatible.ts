...
import { HEADER_SESSION, HEADER_SESSION_LEGACY } from "../../../../../../opencode/src/server/shared/header-names"
...
export const oaCompatHelper: ProviderHelper = ({ adjustCacheUsage }) => ({
  ...
  modifyHeaders: (headers: Headers, body: Record<string, any>, apiKey: string) => {
    ...
    headers.set("x-session-affinity", headers.get(HEADER_SESSION) ?? headers.get(HEADER_SESSION_LEGACY) ?? "")
  },
