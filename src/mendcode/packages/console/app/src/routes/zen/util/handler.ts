...
import { and, Database, eq, isNull, lt, or, sql } from "@mendcode/console-core/drizzle/index.js"
import { KeyTable } from "@mendcode/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@mendcode/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@mendcode/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@mendcode/console-core/util/date.js"
import { Identifier } from "@mendcode/console-core/identifier.js"
import { Billing } from "@mendcode/console-core/billing.js"
import { Actor } from "@mendcode/console-core/actor.js"
import { WorkspaceTable } from "@mendcode/console-core/schema/workspace.sql.js"
import { ZenData } from "@mendcode/console-core/model.js"
import { Subscription } from "@mendcode/console-core/subscription.js"
import { BlackData } from "@mendcode/console-core/black.js"
import { UserTable } from "@mendcode/console-core/schema/user.sql.js"
import { ModelTable } from "@mendcode/console-core/schema/model.sql.js"
import { ProviderTable } from "@mendcode/console-core/schema/provider.sql.js"
...
import { LiteData } from "@mendcode/console-core/lite.js"
import { Resource } from "@mendcode/console-resource"
...
} from "../../../../../../opencode/src/server/shared/header-names"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get(HEADER_SESSION) ?? input.request.headers.get(HEADER_SESSION_LEGACY) ?? ""
    const requestId = input.request.headers.get(HEADER_REQUEST) ?? input.request.headers.get(HEADER_REQUEST_LEGACY) ?? ""
    const projectId = input.request.headers.get(HEADER_PROJECT) ?? input.request.headers.get(HEADER_PROJECT_LEGACY) ?? ""
    const ocClient = input.request.headers.get(HEADER_CLIENT) ?? input.request.headers.get(HEADER_CLIENT_LEGACY) ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete(HEADER_REQUEST)
          headers.delete(HEADER_REQUEST_LEGACY)
          headers.delete(HEADER_SESSION)
          headers.delete(HEADER_SESSION_LEGACY)
          headers.delete(HEADER_PROJECT)
          headers.delete(HEADER_PROJECT_LEGACY)
          headers.delete(HEADER_CLIENT)
          headers.delete(HEADER_CLIENT_LEGACY)
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `/workspace/${authInfo.workspaceID}/members`
