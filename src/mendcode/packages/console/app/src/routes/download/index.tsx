        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("mend init")}>
                <code>
                  <strong>mend init</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("MendCode desktop downloads are not published yet")}>
                <code>
                  <strong>MendCode desktop downloads are not published yet</strong>
                </code>
                <CopyStatus />
              </button>
