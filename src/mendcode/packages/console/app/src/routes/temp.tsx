    ...
    <main data-page="home">
      ...
      <div data-component="content">
        ...
        <section data-component="cta">
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                <span data-slot="highlight">mend init</span>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                <strong>MendCode package is not published yet</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          ...
          <div data-slot="cell">
            <a href={language.route("/download")}>{i18n.t("download.title")}</a>
          </div>
          <div data-slot="cell">
            <a href="/auth">{i18n.t("temp.zen")}</a>
          </div>
