...
export const defaultRegistryState: RuntimeRegistryState = {
  ...
  entries: [
    ...
    },
    {
      id: "official",
      type: "github",
      url: "https://github.com/MendCode/mendcode-marketplace.git",
      enabled: true,
      trust: "public",
      note: "Official public MendCode marketplace registry. Packages become official through PR review.",
      channel: "stable",
      trustPolicy: { requireSignature: false, allowUnsigned: true },
      import: { mode: "mendcode" },
    },
  ],
  redaction: {
    shared: [
      ...
      ".mendcode/plugins/**/*.{ts,js}",
      ".mendcode/tools/**/*.{ts,js}",
      ".mendcode/prompts/**/*.md",
