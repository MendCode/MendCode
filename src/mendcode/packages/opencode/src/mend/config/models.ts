...
export const modelPresets = {
  "openai-codex-subscription-gpt-6-astra": {
    providerID: "openai",
    modelID: "gpt-6-astra",
    ...
    note: "Uses the Codex-supported GPT-6 Astra model with ChatGPT Plus/Pro OAuth when the account rollout includes Astra; not OpenAI API billing.",
  },
  ...
  "openai-codex-subscription-gpt-5.6-terra": {
    providerID: "openai",
    ...
    pricingPer1MTokens: null,
    source: ".agents/vendor/opencode/packages/opencode/src/plugin/codex.ts",
    note: "Uses the Codex-supported GPT-5.6 Terra model with ChatGPT Plus/Pro OAuth; not OpenAI API billing.",
  },
  "openai-codex-subscription-gpt-5.6-luna": {
    providerID: "openai",
    ...
    pricingPer1MTokens: null,
    source: ".agents/vendor/opencode/packages/opencode/src/plugin/codex.ts",
    note: "Uses the Codex-supported GPT-5.6 Luna model with ChatGPT Plus/Pro OAuth; not OpenAI API billing.",
  },
  ...
  "openai-api-gpt-5.6": {
    ...
    authMode: "api-key",
    env: ["OPENAI_API_KEY"],
    pricingPer1MTokens: { inputUsd: 4, cachedInputUsd: 0.4, outputUsd: 20 },
    source: "https://developers.openai.com/api/docs/models/gpt-5.6-sol",
    note: "OpenAI API billing; GPT-5.6 alias for the Sol tier with max reasoning support.",
  },
  "openai-api-gpt-6-astra": {
    ...
    authMode: "api-key",
    env: ["OPENAI_API_KEY"],
    pricingPer1MTokens: { inputUsd: 10, cachedInputUsd: 1, outputUsd: 50 },
    source: "https://developers.openai.com/api/docs/models/gpt-6-astra",
    note: "OpenAI API billing; flagship GPT-6 Astra for the hardest reasoning and coding work.",
  },
  "openai-api-gpt-5.6-terra": {
    ...
    authMode: "api-key",
    env: ["OPENAI_API_KEY"],
    pricingPer1MTokens: { inputUsd: 2, cachedInputUsd: 0.2, outputUsd: 12 },
    source: "https://developers.openai.com/api/docs/models/gpt-5.6-terra",
    note: "OpenAI API billing; GPT-5.6 Terra for balanced everyday work.",
  },
  "openai-api-gpt-5.6-luna": {
    ...
    authMode: "api-key",
    env: ["OPENAI_API_KEY"],
    pricingPer1MTokens: { inputUsd: 0.2, cachedInputUsd: 0.02, outputUsd: 1.2 },
    source: "https://developers.openai.com/api/docs/models/gpt-5.6-luna",
    note: "OpenAI API billing; GPT-5.6 Luna for cost-efficient high-volume work.",
  },
