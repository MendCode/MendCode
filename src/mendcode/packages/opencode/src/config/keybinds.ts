...
const KeybindsSchema = Schema.Struct({
  ...
  sidebar_toggle: keybind("none", "Disabled in MendCode"),
  ...
  session_history: keybind("<leader>shift+g", "Browse complete session history"),
  session_history_search: keybind("/", "Quick Jump through complete session history"),
  session_history_open: keybind("return", "Open selected history turn"),
  session_history_back: keybind("escape", "Return from session history"),
  session_history_live: keybind("l", "Return to the live session"),
  session_history_view: keybind("v", "Cycle session history view"),
  session_history_split: keybind("s", "Toggle session history preview pane"),
  ...
  session_share: keybind("none", "Disabled in MendCode"),
  session_unshare: keybind("none", "Disabled in MendCode"),
  ...
  help: keybind("?", "Open help"),
  agent_mode_picker: keybind("shift+tab", "Open mode picker"),
  agent_list: keybind("<leader>a", "List primary agents"),
  agent_cycle: keybind("tab", "Next primary agent"),
