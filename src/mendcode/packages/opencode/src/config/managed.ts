...
const MANAGED_PLIST_DOMAIN = "ai.mendcode.managed"

// Keys injected by macOS/MDM into the managed plist that are not MendCode config
...
export function managedConfigDir() {
  return (
    process.env.MENDCODE_TEST_MANAGED_CONFIG_DIR ||
