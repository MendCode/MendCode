    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".mendcode", "plans", "*.md")]: "allow",
        ...
        const get = Effect.fnUntraced(function* (agent: string) {
          const normalized = agent.replace(/^(?:sub|subagent)[/-]+/i, "")
          return agents[agent] ?? agents[normalized] ?? agents[`sub/${normalized}`] ?? agents[`subagent/${normalized}`]
        })
