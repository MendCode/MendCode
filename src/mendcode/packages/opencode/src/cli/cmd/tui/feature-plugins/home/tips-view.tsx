...
const TIPS = [
  ...
  "Use {highlight}mend run{/highlight} for non-interactive scripting",
  "Use {highlight}mend run --continue{/highlight} to resume the last session",
  "Use {highlight}mend run -f file.ts{/highlight} to attach files via CLI",
  ...
  "Run {highlight}mend providers status{/highlight} to see all configured providers",
  "Run {highlight}mend auth status openai{/highlight} to inspect OpenAI auth status",
  "Use GitHub workflow comments only after your MendCode automation is configured",
  "Run {highlight}mend upstream status{/highlight} before changing donor-derived automation flows",
  ...
  "Run {highlight}mend status{/highlight} to troubleshoot configuration and project state",
