...
const TUI_SCHEMA_URL = "https://mendcode.ai/tui.json"
...
/**
 * Migrates tui-specific keys (theme, keybinds, tui) from mendcode.json files
...
async function opencodeFiles(input: { directories: string[]; cwd: string }) {
  const files = [
    ...
    ...(await Filesystem.findUp(["mendcode.json", "mendcode.jsonc"], input.cwd, undefined, { rootFirst: true })),
  ]
