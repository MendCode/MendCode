import {
  HEADER_DIRECTORY,
  HEADER_DIRECTORY_LEGACY,
  HEADER_WORKSPACE,
  HEADER_WORKSPACE_LEGACY,
...
function sanitize(out: Headers) {
  ...
  out.delete(HEADER_DIRECTORY)
  out.delete(HEADER_DIRECTORY_LEGACY)
  out.delete(HEADER_WORKSPACE)
  out.delete(HEADER_WORKSPACE_LEGACY)
}
