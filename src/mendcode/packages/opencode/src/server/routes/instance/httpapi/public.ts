...
import { MendCodeHttpApi } from "./api"
...
const LegacyComponentDescriptions = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for MendCode serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw = OpenApi.fromApi(MendCodeHttpApi) as unknown as OpenApiSpec
...
export const PublicApi = MendCodeHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "MendCode",
    version: "1.0.0",
    description: "MendCode API",
