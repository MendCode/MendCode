...
export const BackgroundRegisterPayload = Schema.Struct({
  state: Schema.optional(BackgroundSession.State),
  summary: Schema.optional(Schema.String),
  error: Schema.optional(Schema.String),
  pinned: Schema.optional(Schema.Boolean),
})
export const BackgroundWriterPayload = Schema.Struct({
...
export const BackgroundWriterResult = Schema.Union([
  Schema.Struct({
    ...
    info: BackgroundSession.Info,
  }),
  Schema.Struct({
    acquired: Schema.Literal(false),
    info: Schema.optional(BackgroundSession.Info),
  }),
])
  ...
  .add(
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.get("backgroundList", SessionPaths.background, {
          success: described(Schema.Array(BackgroundSession.Entry), "List of background sessions"),
          error: HttpApiError.BadRequest,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "session.background.list",
        ...
        HttpApiEndpoint.post("backgroundRegister", SessionPaths.backgroundRegister, {
          params: { sessionID: SessionID },
          payload: BackgroundRegisterPayload,
          success: described(BackgroundSession.Info, "Background session metadata"),
          error: [HttpApiError.BadRequest, ApiNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "session.background.register",
            summary: "Register background session",
            description: "Mark a session as background-managed for Agent View.",
          }),
        ),
        HttpApiEndpoint.delete("backgroundRemove", SessionPaths.backgroundRegister, {
          params: { sessionID: SessionID },
          success: described(Schema.Boolean, "Removed background session"),
          error: [HttpApiError.BadRequest, ApiNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "session.background.remove",
