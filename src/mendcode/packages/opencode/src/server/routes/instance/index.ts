...
export const InstanceRoutes = (upgrade: UpgradeWebSocket, opts?: CorsOptions): Hono => {
  ...
  if (Flag.OPENCODE_EXPERIMENTAL_HTTPAPI) {
    ...
    app.get("/plan-review", (c) => handler(c.req.raw, context))
    app.post("/plan-review/:requestID/reply", (c) => handler(c.req.raw, context))
    ...
    app.get(SessionPaths.background, (c) => handler(c.req.raw, context))
    app.get(SessionPaths.get, (c) => handler(c.req.raw, context))
    app.post(SessionPaths.backgroundRegister, (c) => handler(c.req.raw, context))
    app.delete(SessionPaths.backgroundRegister, (c) => handler(c.req.raw, context))
    app.post(SessionPaths.backgroundWriter, (c) => handler(c.req.raw, context))
    app.delete(SessionPaths.backgroundWriter, (c) => handler(c.req.raw, context))
  ...
  return app
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose the current MendCode instance, releasing all resources.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get paths",
        description: "Retrieve the current working directory and related path information for the MendCode instance.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all available commands in the MendCode system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List agents",
        description: "Get a list of all available AI agents in the MendCode system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List skills",
        description: "Get a list of all available skills in the MendCode system.",
