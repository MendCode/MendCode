...
describe("ProviderTransform.options - gpt-5 textVerbosity", () => {
  ...
  test("gpt-5.5 requests reasoning summaries by default", () => {
    ...
    const msgs = [
      ...
      { role: "assistant", content: text("assistant string") },
      {
        ...
        content: [
          ...
          { type: "tool-call", toolCallId: "call-1", toolName: "Read", input: { filePath: ".mendcode/tool/emoji.ts" } },
          {
            type: "tool-result",
            toolCallId: "call-2",
            toolName: "Read",
...
describe("ProviderTransform.variants", () => {
  ...
  describe("@ai-sdk/openai", () => {
    test("gpt-5-pro returns high effort with reasoningSummary", () => {
      const model = createMockModel({
        id: "gpt-5-pro",
        providerID: "openai",
        api: {
    ...
    test("gpt-5.5 includes xhigh effort with reasoningSummary", () => {
      const model = createMockModel({
        id: "gpt-5.5",
        providerID: "openai",
        api: {
    ...
    test("non-versioned models after 2025-12-04 include 'xhigh' effort", () => {
      const model = createMockModel({
        id: "gpt-5-mini",
        providerID: "openai",
        api: {
    ...
    test("dotted gpt-5.x ids use versioned efforts (regression: matcher used to miss gpt-5.4)", () => {
      const model = createMockModel({
        id: "gpt-5.4",
        providerID: "openai",
        api: {
