...
import type {
  ...
  PlanReviewReply,
  PlanReviewReplyErrors,
  PlanReviewReplyResponses,
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the MendCode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the MendCode system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global MendCode configuration settings and preferences.
   */
   ...
   *
   * Update global MendCode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the MendCode server.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all MendCode instances, releasing all resources.
   */
  ...
  /**
   * Upgrade MendCode runtime
   *
   * Upgrade the MendCode runtime to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current MendCode configuration settings and preferences.
   */
   ...
   *
   * Update MendCode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current MendCode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the MendCode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with MendCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that MendCode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by MendCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class PlanReview extends HeyApiClient {
   ...
   *
   * Apply, edit, reject, or close a plan review request from the AI assistant.
   */
  public reply<ThrowOnError extends boolean = false>(
    parameters: {
      requestID: string
      directory?: string
      workspace?: string
      planReviewReply?: PlanReviewReply
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            ...
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "planReviewReply", map: "body" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<PlanReviewReplyResponses, PlanReviewReplyErrors, ThrowOnError>({
      url: "/plan-review/{requestID}/reply",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all MendCode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new MendCode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific MendCode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
  ...
  /**
   * Disabled session sharing removal
   *
   * Session sharing is disabled in MendCode builds.
   */
