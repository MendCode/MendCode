...
/**
 * Server configuration for MendCode serve and web commands
 */
...
export type PlanReviewReplyData = {
  body?: PlanReviewReply
  path: {
    requestID: string
  }
  query?: {
...
export type PlanReviewReplyErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type PlanReviewReplyError = PlanReviewReplyErrors[keyof PlanReviewReplyErrors]

export type PlanReviewReplyResponses = {
  /**
   * Plan review answered successfully
   */
  200: boolean
}

export type PlanReviewReplyResponse = PlanReviewReplyResponses[keyof PlanReviewReplyResponses]
