export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MendCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MendCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
