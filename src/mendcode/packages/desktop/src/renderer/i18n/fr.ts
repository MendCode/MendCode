export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'MendCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'MendCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
