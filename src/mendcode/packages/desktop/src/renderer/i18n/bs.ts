export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju MendCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} MendCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
