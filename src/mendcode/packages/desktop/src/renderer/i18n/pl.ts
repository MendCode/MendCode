export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji MendCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} MendCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
