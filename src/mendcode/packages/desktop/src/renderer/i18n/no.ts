export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MendCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MendCode er lastet ned. Vil du installere den og starte på nytt?",
