export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MendCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MendCode er blevet downloadet. Vil du installere den og genstarte?",
