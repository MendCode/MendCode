...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "MendCode Runtime Docs", click: () => shell.openExternal("https://mendcode.ai/docs") },
        { label: "MendCode Community", click: () => shell.openExternal("https://mendcode.ai") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "MendCode Feature Request",
          click: () => shell.openExternal("https://mendcode.ai"),
        },
        {
          label: "MendCode Bug Report",
          click: () => shell.openExternal("https://mendcode.ai"),
        },
      ],
    },
