...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
    mv $out/bin/MendCode $out/bin/opencode-desktop
    sed -i 's|^Exec=MendCode$|Exec=opencode-desktop|' $out/share/applications/MendCode.desktop
  '';

  meta = {
    description = "MendCode Desktop App";
    homepage = "https://mendcode.ai";
